  ...
  types: [
    /* 1) VERZEKERINGEN */
    {
      ...
      fields: [
        ...
        {
          key: 'type_verzekering',
          label: 'Type verzekering',
          type: 'select',
          required: false,
          options: ['Auto', 'Woning', 'Reis', 'Aansprakelijkheid', 'Overig'],
        },
        {
          key: 'verzekerd_bedrag',
        ...
        {
          key: 'premie_per_jaar',
          label: 'Premie per jaar',
          type: 'currency',
          required: false,
        },
        {
          key: 'betalingsfrequentie',
    ...
    /* 2) ICT-APPARATUUR */
    {
      ...
      fields: [
        ...
        {
          key: 'aankoopwaarde',
          label: 'Waarde bij aankoop',
          type: 'currency',
          required: false,
        },
        {
          key: 'locatie',
          label: 'Locatie (huis/kantoor)',
          type: 'text',
          required: false,
        },
    ...
    /* 4) DOMEINNAMEN */
    {
      ...
      fields: [
        ...
        {
          key: 'hostingprovider',
          label: 'Hostingprovider',
          type: 'text',
          required: false,
        },
        {
          key: 'autorisatiecode',
          label: 'Autorisatiecode',
          type: 'text',
          required: false,
        },
      ],
    ...
    /* 5) VASTGOED */
    {
      ...
      fields: [
        { key: 'adres', label: 'Adres', type: 'text', required: true },
        {
          ...
          type: 'select',
          required: true,
          options: ['Woning', 'Appartement', 'Garage', 'Grond'],
        },
        {
          key: 'aankoopdatum',
          label: 'Aankoopdatum',
    ...
    /* 8) BANKREKENINGEN */
    {
      ...
      fields: [
        ...
        { key: 'iban', label: 'IBAN', type: 'text', required: true },
        {
          ...
          type: 'select',
          required: false,
          options: ['Betaal', 'Spaar', 'Beleggings'],
        },
        {
          key: 'valuta',
          label: 'Valuta',
    ...
    /* 9) BELEGGINGEN */
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'select',
          required: false,
          options: ['Aandelen', 'Obligaties', 'ETF', 'Fonds', 'Alternatief'],
        },
        {
          key: 'valuta',
          label: 'Valuta',
    ...
    /* 10) PENSIOENEN */
    {
      ...
      fields: [
        {
          key: 'maatschappij',
          label: 'Uitvoerder/Maatschappij',
          type: 'text',
          required: true,
        },
        {
          key: 'polisnummer',
          label: 'Polis-/Deelnemingsnr.',
          type: 'text',
          required: true,
        },
        { key: 'startjaar', label: 'Startjaar', type: 'text', required: false },
        {
          key: 'jaarlijkse_opbouw',
          label: 'Jaarlijkse opbouw',
          type: 'currency',
          required: false,
        },
        {
          key: 'verwachte_uitkering',
          label: 'Verwachte uitkering',
          type: 'currency',
          required: false,
        },
        {
          key: 'pensioenleeftijd',
    ...
    /* 13) INTERIEUR-ITEMS */
    {
      ...
      fields: [
        { key: 'naam', label: 'Item', type: 'text', required: true },
        {
          ...
          type: 'select',
          required: true,
          options: ['Meubel', 'Apparaat', 'Verlichting', 'Decoratie'],
        },
    ...
    /* 14) HUISHOUDELIJKE APPARATEN */
    {
      ...
      fields: [
        { key: 'naam', label: 'Apparaat', type: 'text', required: true },
        {
          ...
          type: 'select',
          required: true,
          options: ['Keuken', 'Schoonmaak', 'Wassen/Drogen', 'Overig'],
        },
        { key: 'merk', label: 'Merk', type: 'text', required: false },
        { key: 'model', label: 'Model', type: 'text', required: false },
        {
      ...
      fields: [
        {
          ...
          type: 'select',
          required: true,
          options: ['Auto', 'Motor', 'Fiets', 'Boot', 'Overig'],
        },
        { key: 'merk', label: 'Merk', type: 'text', required: true },
        {
          key: 'identificatie',
          label: 'Kenteken/Identificatie',
          type: 'text',
          required: true,
        },
      ...
      fields: [
        {
          ...
          type: 'select',
          required: true,
          options: ['Paspoort', 'ID-kaart', 'VISA', 'Overig'],
        },
        {
          key: 'nummer',
    ...
    /* 19) ZAKELIJKE BELANGEN */
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'select',
          required: true,
          options: ['Bedrijf', 'Aandelen', 'Partnerschap', 'Overig'],
        },
        {
          key: 'percentage',
          label: 'Percentage eigendom',
          type: 'number',
          required: false,
        },
    ...
    /* 20) TECHNISCHE INSTALLATIES */
    {
      ...
      fields: [
        ...
        {
          key: 'installatiedatum',
          label: 'Installatiedatum',
          type: 'date',
          required: false,
        },
        {
          key: 'onderhoudsinterval',
          label: 'Onderhoudsinterval',
          type: 'text',
          required: false,
        },
        { key: 'contract', label: 'Contract', type: 'file', required: false },
