    ...
    >
      ...
      >
        <div style={{ maxWidth: 1080, margin: "0 auto" }}>
          ...
          >
            PAM helpt je belangrijke bezittingen, documenten en contactpersonen
            stap voor stap vast te leggen. Voor jezelf, en voor de mensen die
            ooit moeten weten wat er is en waar het staat.
          </p>
