...
export function buildAssetTypeReport(
  assets: Asset[],
  docs: Doc[],
  people: Person[],
  type: string,
...
export function buildSelectedAssetsReport(
  assets: Asset[],
  docs: Doc[],
  selectedIds: string[],
) {
...
export function buildTotalReport(
  assets: Asset[],
  docs: Doc[],
  people: Person[],
) {
  ...
  const { addFooter } = withHeaderFooter(
    doc,
    'Totaalrapport — Assets, Docs, Mensen',
  );
